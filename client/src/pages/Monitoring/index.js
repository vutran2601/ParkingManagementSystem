...
const CheckOut = (props) => {
    ...
    const handleCheckOut = async (vehicleid_req) => {
        try {
            const response = await axios.patch('http://localhost:5000/vehicle/checkout', {
...
const FuelCharge = (props) => {
    ...
    const handleFuelCharge = async (formSubmit) => {
        await axios.patch('http://localhost:5000/vehicle/fuelcharge', {
            vehicleid: formSubmit.vehicleid,
...
const ChangeOil = (props) => {
    ...
    const handleChangeOil = async (vehicleid_req) => {
        await axios.patch('http://localhost:5000/vehicle/changeoil', {
            vehicleid: vehicleid_req,
        });
    };
...
const Washing = (props) => {
    ...
    const handleWashing = async (vehicleid_req) => {
        await axios.patch('http://localhost:5000/vehicle/washing', {
            vehicleid: vehicleid_req,
        });
    };
            ...
            <TextField
                ...
                onChange={async (event) => {
                    ...
                    const response = await axios.get(
                        'http://localhost:5000/vehicle/search',
                        {
                            params: {
...
export default function Page() {
    ...
    const FetchVehicleRecords = async () => {
        const response = await axios.get(
            'http://localhost:5000/vehicle/getall'
        );
